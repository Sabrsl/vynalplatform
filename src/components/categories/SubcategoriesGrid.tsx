...
const SubcategoriesGrid: React.FC<SubcategoriesGridProps> = ({
  ...
  const handleSubcategoryClick = useCallback(
    (e: React.MouseEvent, subcategory: Subcategory | UISubcategoryType) => {
      e.preventDefault();
            ...
            {group.map((subcategory) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={
                    !prefersReducedMotion ? { scale: 1.02 } : undefined
                  }
                  ...
                  <div
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter" || e.key === " ") {
                        e.preventDefault();
                        handleSubcategoryClick(e as any, subcategory);
                      }
                    }}
                  >
                    <div className={getItemClassName(isSelected)}>
                      <span
                        className={`text-[9px] xs:text-[10px] sm:text-[11px] truncate max-w-full
