...
export function OrderSummary({
  ...
  return (
    <>
      <DialogContent className="max-w-md" aria-labelledby="order-summary-title" aria-describedby="order-summary-description">
        <DialogHeader>
          <DialogTitle id="order-summary-title">Résumé de la commande</DialogTitle>
