...
export function OrderTimelineTab({ order }: OrderTimelineTabProps) {
  return (
    <div className="p-3 sm:p-4 space-y-4 sm:space-y-6">
      {/* Cahier des charges */}
      <div>
        <h3 className="text-xs sm:text-sm font-medium text-vynal-purple-light dark:text-vynal-text-primary mb-2">Cahier des charges</h3>
        <div className="text-[8px] sm:text-[10px] text-vynal-purple-secondary dark:text-vynal-text-secondary p-3 sm:p-4 rounded-md border border-vynal-purple-secondary/10 dark:border-vynal-purple-secondary/20 bg-vynal-purple-secondary/5 dark:bg-vynal-purple-secondary/10">
      ...
      {/* Chronologie */}
      <div>
        <h3 className="text-xs sm:text-sm font-medium text-vynal-purple-light dark:text-vynal-text-primary mb-2 sm:mb-3">Chronologie</h3>
        <div className="relative pl-5 sm:pl-6 border-l border-vynal-purple-secondary/20 dark:border-vynal-purple-secondary/30 space-y-3 sm:space-y-4">
          <div className="relative">
            ...
            <p className="text-[8px] sm:text-[10px] font-medium text-vynal-purple-light dark:text-vynal-text-primary">Commande créée</p>
            <p className="text-[8px] sm:text-[9px] text-vynal-purple-secondary dark:text-vynal-text-secondary/80">
          ...
          {order.status !== "pending" && order.status !== "cancelled" && (
            <div className="relative">
              ...
              <p className="text-[8px] sm:text-[10px] font-medium text-vynal-purple-light dark:text-vynal-text-primary">Projet en cours</p>
              <p className="text-[8px] sm:text-[9px] text-vynal-purple-secondary dark:text-vynal-text-secondary/80">
          ...
          {order.status === "cancelled" && (
            <div className="relative">
              ...
              <p className="text-[8px] sm:text-[10px] font-medium text-vynal-purple-light dark:text-vynal-text-primary">Commande annulée</p>
              <p className="text-[8px] sm:text-[9px] text-vynal-purple-secondary dark:text-vynal-text-secondary/80">
          ...
          {order.status === "in_dispute" && (
            <div className="relative">
              ...
              <p className="text-[8px] sm:text-[10px] font-medium text-vynal-purple-light dark:text-vynal-text-primary">Litige ouvert</p>
              <p className="text-[8px] sm:text-[9px] text-vynal-purple-secondary dark:text-vynal-text-secondary/80">
                {format(new Date(), 'dd MMMM yyyy', { locale: fr })}
              </p>
            </div>
          ...
          {(order.status === "delivered" || order.status === "revision_requested" || order.status === "completed") ? (
            <div className="relative">
              ...
              <p className="text-[8px] sm:text-[10px] font-medium text-vynal-purple-light dark:text-vynal-text-primary">Livraison</p>
              <p className="text-[8px] sm:text-[9px] text-vynal-purple-secondary dark:text-vynal-text-secondary/80">
          ...
          {order.status === "revision_requested" && (
            <div className="relative">
              ...
              <p className="text-[8px] sm:text-[10px] font-medium text-vynal-purple-light dark:text-vynal-text-primary">Révision demandée</p>
              <p className="text-[8px] sm:text-[9px] text-vynal-purple-secondary dark:text-vynal-text-secondary/80">
                {format(new Date(), 'dd MMMM yyyy', { locale: fr })}
              </p>
            </div>
          ...
          {order.status === "completed" && (
            <div className="relative">
              ...
              <p className="text-[8px] sm:text-[10px] font-medium text-vynal-purple-light dark:text-vynal-text-primary">Commande terminée</p>
              <p className="text-[8px] sm:text-[9px] text-vynal-purple-secondary dark:text-vynal-text-secondary/80">
                {format(new Date(), 'dd MMMM yyyy', { locale: fr })}
              </p>
            </div>
      ...
      {order.delivery && (
        <div>
          <h3 className="text-xs sm:text-sm font-medium text-vynal-purple-light dark:text-vynal-text-primary mb-2">Message de livraison</h3>
          <div className="text-[8px] sm:text-[10px] text-vynal-purple-secondary dark:text-vynal-text-secondary p-3 sm:p-4 rounded-md border border-vynal-purple-secondary/10 dark:border-vynal-purple-secondary/20 bg-vynal-purple-secondary/5 dark:bg-vynal-purple-secondary/10">
