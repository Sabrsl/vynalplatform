    ...
    <div className="fixed inset-0 z-[9999] bg-white dark:bg-vynal-purple-dark flex flex-col items-center justify-start pt-6 animate-in fade-in">
      <div className="container mx-auto px-4 w-full max-w-7xl">
        <div className="space-y-6">
          ...
          {/* Tabs */}
          <Skeleton className="h-10 w-64 mb-4 bg-vynal-purple-secondary/30" />
            ...
            {[...Array(6)].map((_, i) => (
              <Card key={i} className="dark:border-vynal-purple-secondary/40">
                <div className="aspect-video relative overflow-hidden">
                  <Skeleton className="h-full w-full bg-vynal-purple-secondary/30" />
                </div>
                <CardContent className="p-4 space-y-3">
                  <Skeleton className="h-6 w-3/4 bg-vynal-purple-secondary/30" />
                  <Skeleton className="h-4 w-full bg-vynal-purple-secondary/30" />
                  <Skeleton className="h-4 w-1/2 bg-vynal-purple-secondary/30" />
                  <div className="flex justify-between items-center pt-2">
                    <Skeleton className="h-6 w-20 bg-vynal-purple-secondary/30" />
