...
export default function LoginForm({ redirectPath = "/dashboard" }: LoginFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Connexion directe via Supabase sans vérification 2FA
  ...
  // Gestionnaire pour la connexion avec Google
  ...
  // Gestionnaire pour la connexion avec GitHub
  ...
  // Gestionnaire pour la connexion avec LinkedIn
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        >
          {isLoading ? (
            ...
            <>
              <svg className="h-4 w-4 flex-shrink-0" viewBox="0 0 24 24" fill="#0A66C2">
