          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-4">
            ...
            <div className="flex items-center justify-start md:justify-end text-gray-400 dark:text-vynal-text-secondary md:text-right">
              <span className="text-[9px] opacity-70">
                ...
                <span className="ml-2 inline-flex items-center px-1 py-0.5 rounded text-[8px] font-medium bg-vynal-purple-light/10 text-vynal-purple-light dark:bg-vynal-accent-primary/10 dark:text-vynal-accent-primary">v0.1.138</span>
              </span>
            </div>
          </div>
        </motion.div>
