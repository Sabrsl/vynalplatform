...
const useInView = (
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        // Simplement mettre à jour l'état sans interferer avec le scroll
...
const textStyles = {
  title: (isDark: boolean) => cn("text-vynal-title"),
  secondary: (isDark: boolean) => cn("text-vynal-body"),
  accent: (isDark: boolean) =>
    cn(isDark ? "text-vynal-accent-primary" : "text-[#A020F0]"),
};
 ...
 */
const ServiceErrorView = React.memo(
  ({
    error,
    onBack,
    isDarkMode,
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      >
        ...
        >
          ...
          />
          <h2 className="text-lg font-semibold text-vynal-title">
            Service non disponible
          </h2>
        </div>
        <CardContent className="p-6">
          <p className="mb-6 text-vynal-body">
            {error || "Ce service n'existe pas ou a été supprimé."}
          </p>
          <div className="flex flex-wrap gap-2">
            {onBack ? (
              ...
              <Link href={PUBLIC_ROUTES.SERVICES} className="group">
                ...
                >
                  <ArrowLeft
                    className="h-3 w-3 mr-1 group-hover:-translate-x-1 transition-transform icon-vynal"
                    aria-hidden="true"
                  />
                  Retour aux services
                </Button>
 ...
 */
const ServiceLoadingView = React.memo(
    ...
    return (
      <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
        ...
        >
          ...
          <h3 className="text-lg font-bold mb-4 text-vynal-title">
            Partager ce service
          </h3>
          ...
          <div className="mt-6 flex justify-end">
            <Button
              variant="outline"
              onClick={onClose}
              className={cn("btn-vynal-outline", isDarkMode ? "dark" : "light")}
            >
              Fermer
            </Button>
          </div>
      ...
      >
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-5 gap-2 mb-3">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        `https://x.com/intent/tweet?url=${encodeURIComponent(shareUrl || window.location.href)}&text=${encodeURIComponent(`Découvrez ce service: ${title || "Service"} sur Vynal Platform`)}`,
                        "_blank",
                      )
                    }
                  >
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        `https://wa.me/?text=${encodeURIComponent(`Découvrez ce service sur Vynal Platform: ${shareUrl || window.location.href}`)}`,
                        "_blank",
                      )
                    }
                  >
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        `https://t.me/share/url?url=${encodeURIComponent(shareUrl || window.location.href)}&text=${encodeURIComponent(`Découvrez ce service: ${title || "Service"} sur Vynal Platform`)}`,
                        "_blank",
                      )
                    }
                  >
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        `mailto:?subject=${encodeURIComponent(`Découvrez ce service sur Vynal Platform`)}&body=${encodeURIComponent(`Hey, je voulais partager ce service avec toi: ${title || "Service"}\n${shareUrl || window.location.href}`)}`,
                        "_blank",
                      )
                    }
                  >
        ...
        <div className="flex items-center">
          <div className="w-3 flex justify-center">
            <Tag
              className="h-3 w-3 flex-shrink-0 icon-vynal"
              aria-hidden="true"
            />
          </div>
        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center ml-0.5">
            <p className="text-[10px] mr-1 text-vynal-body">
              Temps de livraison:
            </p>
 ...
 */
const ServiceGuarantees = React.memo(
      ...
      <ul className="space-y-2 md:space-y-2 lg:space-y-1 mt-1">
        <li className="flex items-center">
          ...
          <span className="text-xs ml-1.5 text-vynal-body">
            Livraison en {deliveryTime} jour
            {Number(deliveryTime) > 1 ? "s" : ""}
          </span>
        </li>
        <li className="flex items-center">
          <div className="w-4 flex justify-center">
              ...
              {freelance.is_certified && freelance.certification_type && (
                ...
                >
                  <div>
                    <CertificationBadge
                      type={
                        freelance.certification_type as
                          | "standard"
                          | "premium"
                          | "expert"
                      }
...
const ServiceView: React.FC<ServiceViewProps> = (props) => {
  ...
  const user = useUser();
  const { averageRating, reviewCount } = useFreelancerRating(
    service?.profiles?.id || "",
  );
      ...
      freelance: service.profiles
        ? {
            ...
            avatar_url:
              ...
              typeof service.profiles.avatar_url === "string" &&
              service.profiles.avatar_url.trim() !== ""
                ? service.profiles.avatar_url
                : null,
          }
        : {
  ...
  const freelanceInitials = useMemo(() => {
    ...
    try {
      const nameSource =
        serviceMeta.freelance.full_name ||
          ...
          if (currentSection) {
            formattedSections.push(
              <div key={currentSection} className="mb-4">
                <h3 className="text-sm font-semibold mb-2 text-vynal-title">
                  {currentSection}
                </h3>
                <div className="text-xs text-vynal-body whitespace-pre-wrap">
                  {currentContent}
                </div>
              </div>,
            );
  ...
  if (loading) {
    return <ServiceLoadingView isDarkMode={isDarkMode} />;
  }
  ...
  return (
    ...
    >
      ...
      {false && !isFreelanceView && (
        ...
        >
          <div
            className={`absolute inset-0 bg-[url('/img/grid-pattern.svg')] bg-center ${isDarkMode ? "opacity-20" : "opacity-0"}`}
          ></div>
          <div
      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-3 relative">
        ...
        {isFreelanceView && (
          <div className="flex items-center mb-4 pt-4">
            ...
            <h1 className="text-2xl font-normal text-vynal-title">
              Détails du service
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 lg:gap-6">
          ...
          <div className="md:col-span-2">
              ...
              {serviceMeta.hasImages ? (
                ...
                <div
                  className={cn(
                    ...
                    isDarkMode
                      ? "bg-vynal-purple-secondary/10"
                      : "bg-gray-50 border border-[#E0E0E0]",
                  )}
                >
                  <ImageIcon
                    className="h-10 w-10 md:h-12 md:w-12 text-vynal-body"
                    aria-hidden="true"
                  />
                  <span className="ml-2 text-vynal-body">
            ...
            <Card className={cn("card-vynal", isDarkMode ? "dark" : "light")}>
              <CardContent className="p-4 sm:p-4 lg:p-5">
                ...
                {isFreelanceView && serviceMeta.active !== undefined && (
                  <div className="mb-4 flex justify-between items-center">
                    <Badge
                      variant={serviceMeta.active ? "default" : "secondary"}
                      className={
                        serviceMeta.active
                    ...
                    <span className="text-xs text-vynal-body">
                      ID: {serviceMeta.id}
                    </span>
                  </div>
                )}
                ...
                {/* Description du service */}
                <div className="mb-3 md:mb-3">
                  <h2 className="text-base font-semibold mb-2 text-vynal-title">
                    Description
                  </h2>
                  <div
                    className={cn(
                ...
                <CardContent className="p-4 lg:p-4">
                  <div className="space-y-3 mb-4 md:mb-4 lg:mb-4">
                    ...
                    {serviceMeta.freelance && serviceMeta.freelance.id && (
                      <MessagingDialog
                        ...
                        key={`mobile-fixed-messaging-${serviceMeta.freelance.id}`}
                      />
                    )}
                  </div>
                  ...
                  {serviceMeta.freelance && serviceMeta.freelance.id && (
                    <div className="mt-4 pt-4 pb-2 mb-6 sm:mb-0 border-t border-gray-200 dark:border-vynal-purple-secondary/30">
                      ...
                      >
                        <Package2
                          className="h-3.5 w-3.5 mr-1.5 icon-vynal"
                          aria-hidden="true"
                        />
          ...
          >
            <div className="mb-4 sm:mb-5">
              <h2 className="text-base sm:text-lg flex flex-wrap items-center text-vynal-title">
                <Package2
                  className={cn("h-5 w-5 mr-2", textStyles.accent(isDarkMode))}
                  aria-hidden="true"
                />
                <span>
                  Autres services de{" "}
              ...
              <p className="text-xs sm:text-sm ml-7 text-vynal-body">
                Découvrez d'autres services proposés par ce vendeur
              </p>
            </div>
            ...
            {relatedInView && (
              <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5 lg:gap-6">
                {loadingRelated ? (
                  ...
                  >
                    <Package2
                      ...
                      aria-hidden="true"
                    />
                    <p className={cn("mb-1", textStyles.secondary(isDarkMode))}>
                      Ce vendeur n'a pas d'autres services pour le moment
                    </p>
                    <p
                      className={cn(
                        "text-sm",
                    ...
                    >
                      Revenez plus tard pour découvrir ses nouveaux services
                    </p>
                  </div>
                )}
                ...
                {!loadingRelated &&
                  filteredRelatedServices.length > 0 &&
                  filteredRelatedServices.length < 3 && (
                    <div
