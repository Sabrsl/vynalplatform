          ...
          {!selectedUser && (
            <div className="space-y-4">
              ...
              {searchResults.length > 0 ? (
                <div className="max-h-60 overflow-y-auto border border-gray-100 rounded-md divide-y divide-gray-100">
            ...
            <div className="space-y-4">
              ...
              <div>
                <textarea
                  ...
                  className="w-full p-3 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent min-h-[100px] resize-none"
                />
              </div>
            </div>
          )}
