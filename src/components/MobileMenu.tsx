      ...
      <aside className="fixed inset-y-0 left-0 max-w-[280px] w-full bg-white dark:bg-gray-900 z-50 flex flex-col">
        <div className="flex items-center justify-between h-16 px-4 border-b border-slate-100 dark:border-slate-800">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-base font-bold bg-gradient-to-r from-purple-600 to-violet-700 bg-clip-text text-transparent">Vynal</h1>
          </div>
          <button 
            onClick={onClose}
          ...
          <div className="mb-4 relative">
            <div className="relative">
              <input
                ...
                className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-lg py-2 pl-8 pr-3 text-xs outline-none focus:ring-1 focus:ring-purple-300 dark:focus:ring-purple-600 transition-all dark:text-white"
              />
