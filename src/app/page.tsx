    ...
    <PageLayout fullGradient={true}>
      ...
      <section className="text-vynal-text-primary py-16 md:py-24">
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="lg:w-2/5 animate-fade-in">
            <div className="bg-white dark:bg-vynal-purple-dark/90 rounded-xl p-6 shadow-md border border-gray-100 dark:border-vynal-purple-secondary/30">
              <form onSubmit={handleSearch}>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <input 
                    ...
                    className="w-full py-2 px-3 bg-gray-50 dark:bg-vynal-purple-secondary/30 border border-gray-200 dark:border-vynal-purple-secondary/50 rounded-md text-vynal-title dark:text-vynal-text-primary focus:outline-none focus:ring-2 focus:ring-vynal-accent-primary focus:border-vynal-accent-primary placeholder:text-gray-400 dark:placeholder:text-vynal-text-secondary/70"
                    value={searchQuery}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-vynal-title dark:text-vynal-text-primary">Recherchez un service</h3>
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-vynal-title dark:text-vynal-text-primary">Choisissez votre freelance</h3>
                <p className="text-vynal-body dark:text-vynal-text-secondary">
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-vynal-title dark:text-vynal-text-primary">Commandez en toute sécurité</h3>
                <p className="text-vynal-body dark:text-vynal-text-secondary">
      ...
      <section className="text-vynal-title py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="max-w-xl mx-auto mb-8 text-vynal-body">
