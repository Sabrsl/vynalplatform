...
export default function SummaryPage({
  ...
  useEffect(() => {
    if (!authLoading && !user) {
      router.push(
        "/sign-in?callbackUrl=" +
          encodeURIComponent(`/order/${serviceId}/summary`),
      );
    }
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-slate-50 dark:from-vynal-purple-dark dark:to-vynal-purple-darkest font-poppins">
      ...
      <div className="max-w-5xl mx-auto pt-6 px-4 sm:px-6">
        <div className="mt-4 flex justify-between items-center">
          <h1 className="text-sm sm:text-base font-bold text-slate-800 dark:text-vynal-text-primary">
        ...
        <div className="flex items-center justify-center space-x-4 mt-6">
          <div className="flex flex-col items-center">
            <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-vynal-purple-secondary/30 text-vynal-text-secondary flex items-center justify-center text-xs sm:text-sm">
              1
            </div>
            <span className="text-[7px] sm:text-[9px] mt-1 text-vynal-text-secondary">
              Commande
            </span>
          </div>
          <div className="h-[2px] w-12 sm:w-16 bg-vynal-accent-primary"></div>
          <div className="flex flex-col items-center">
            <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-vynal-accent-primary text-vynal-purple-dark flex items-center justify-center text-xs sm:text-sm font-medium">
              2
            </div>
            <span className="text-[7px] sm:text-[9px] mt-1 text-vynal-accent-primary font-medium">
              Confirmation
            </span>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 mt-6">
        <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-xl shadow-lg">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-[10px] sm:text-xs font-medium text-green-500 mb-1">
                Commande confirmée
              </h3>
