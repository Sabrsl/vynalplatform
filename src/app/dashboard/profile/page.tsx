...
export default function ProfilePage() {
  ...
  const usernameIsSet = userProfile?.username && userProfile.username.trim() !== "";
              ...
              {localProfile.avatar_url ? (
                ...
                <div className="absolute -bottom-2 -right-2 flex items-center space-x-2">
                  <ProfileQRShare 
                    ...
                    baseUrl={typeof window !== 'undefined' ? window.location.origin : 'https://vynal-platform.vercel.app'}
                  />
