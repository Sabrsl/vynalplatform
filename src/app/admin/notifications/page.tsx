...
import { EMAIL_NOTIFICATION_TYPES } from '@/lib/workers/notificationWorker';
...
export default function NotificationsAdminPage() {
  ...
  } = useNotificationProcessor(true, 60000);
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>{process.env.NEXT_PUBLIC_EMAIL_PROVIDER || 'Resend'}</span>
                  </div>
                  <div className="flex justify-between">
