...
export default function VendorProfilePage() {
  ...
  // Charger les informations du vendeur - approche similaire à dashboard/profile
  useEffect(() => {
    const fetchVendorData = async () => {
      ...
      setLoading(true);
      try {
        // Récupérer le profil du vendeur avec le pattern similaire à dashboard/profile
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        {/* Profil principal - structure similaire à dashboard/profile */}
