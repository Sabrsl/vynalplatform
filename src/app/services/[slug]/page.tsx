  ...
  try {
      ...
      <div className="min-h-screen bg-white dark:bg-vynal-purple-dark animate-in fade-in duration-300 service-detail-page stable-scroll">
        <main data-content="loaded" role="main">
          <div className="container mx-auto py-8 px-4 md:px-16 lg:px-24 xl:px-32 preserve-scroll">
            ...
            {service && (
              <div role="article" aria-label={`Détails du service ${service.title}`}>
                <ServiceView
                  service={service}
                  loading={false}
                  error={null}
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-vynal-purple-dark flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white dark:bg-vynal-purple-secondary/10 rounded-lg p-6 text-center border border-red-100 dark:border-red-900/30" role="alert">
          <div className="bg-red-50 dark:bg-red-900/20 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">
            <ArrowLeft className="h-6 w-6 text-red-500 dark:text-red-400" aria-hidden="true" />
          </div>
          ...
          <Link href="/services">
            <div className="bg-vynal-accent-primary hover:bg-vynal-accent-primary/90 text-white py-2 px-4 rounded-md transition-colors inline-block" role="button" tabIndex={0}>
              Retour aux services
            </div>
          </Link>
        </div>
...
function ServiceDetailLoading() {
  return (
    <div className="min-h-screen bg-white dark:bg-vynal-purple-dark animate-in fade-in" role="status" aria-label="Chargement du service">
      <div className="container mx-auto px-4 w-full max-w-5xl py-8">
        <div className="flex flex-col md:flex-row gap-8">
          <div className="w-full md:w-2/3">
            <Skeleton className="h-[400px] w-full mb-4 bg-gray-100 dark:bg-vynal-purple-secondary/30" aria-hidden="true" />
          ...
          <div className="w-full md:w-1/3">
            <Skeleton className="h-8 w-3/4 mb-4 bg-gray-100 dark:bg-vynal-purple-secondary/30" aria-hidden="true" />
            <Skeleton className="h-6 w-1/2 mb-2 bg-gray-100 dark:bg-vynal-purple-secondary/30" aria-hidden="true" />
            <Skeleton className="h-32 w-full mb-6 bg-gray-100 dark:bg-vynal-purple-secondary/30" aria-hidden="true" />
            <Skeleton className="h-10 w-full mb-2 bg-gray-100 dark:bg-vynal-purple-secondary/30" aria-hidden="true" />
            <Skeleton className="h-10 w-full bg-gray-100 dark:bg-vynal-purple-secondary/30" aria-hidden="true" />
          </div>
        </div>
      </div>
    </div>
